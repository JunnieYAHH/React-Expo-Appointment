...
>>>>>>> 277c8c0d3d28e8c4faf00f38417ac5f16930a7d9
      ...
      console.log('cannot get the data', error.message)
    }
  },
  ...
  getAllAppointment: async (req, res) => {
    try {
      ...
      res.status(200).json({ message: "All Appointments Was Fetch", appointments });
    } catch (error) {
      console.log('Error on Getting All The Appointment', error.message);
